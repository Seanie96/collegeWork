...
out type);
	...
	void ConstDecl() {
		string name; int type, type2; Obj obj; int reg 
		Expect(36);
		Type(out type1);
		Ident(out name);
		obj = tab.NewObj(name, constant, type1); 
		Expect(18);
		Expr(out reg,
 out type2);
		if (type1 == type2)
...
out typeR);
	...
	static readonly bool[,] set = {
		...
		{x,x,T,x, x,x,x,x, x,x,x,x, x,x,x,x, T,x,x,x, x,x,x,x, x,x,T,x, T,T,T,T, x,T,T,x, T,x,x},
